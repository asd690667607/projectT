...
/**
 * created by dzs at 2019/3/14 09:41<br>
 */
...
public class SysRoleController {
    ...
    @ApiOperation(value = "丁兆双: 增加角色", notes = "")
    @PostMapping
    ...
    @ApiOperation(value = "丁兆双: 删除角色", notes = "")
    @DeleteMapping
    ...
    @ApiOperation(value = "丁兆双: 查询角色", notes = "")
    @PostMapping("/query")
    ...
    @ApiOperation(value = "丁兆双: 更新角色", notes = "")
    @PatchMapping("/info")
    public Json update(@RequestBody String body) {

        String oper = "update role";
        log.info("{}, body: {}", oper, body);
        System.out.println(body+"更新角色");
        SysRole role = JSON.parseObject(body, SysRole.class);
    ...
    @ApiOperation(value = "丁兆双: 更新角色对应权限", notes = "")
    @PatchMapping("/perm")
    ...
    @ApiOperation(value = "丁兆双: 增加角色对应权限", notes = "")
    ...
    @ApiOperation(value = "丁兆双: 删除角色对应权限", notes = "")
    @DeleteMapping("/perm")
    ...
    @ApiOperation(value = "丁兆双: 查询角色对应权限", notes = "")
