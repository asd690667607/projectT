...
/**
 * created by dzs at 2019/3/13 17:15<br>
 */
...
public class SysPermController {
    ...
    @ApiOperation(value = "丁兆双: 菜单列表", notes = "")
    @GetMapping("/list/all")
    ...
    @ApiOperation(value = "丁兆双: 按父级列出菜单", notes = "")
    ...
    @ApiOperation(value = "丁兆双: 同步菜单权限", notes = "")
    ...
    @ApiOperation(value = "丁兆双: 同步API", notes = "")
    ...
    @ApiOperation(value = "丁兆双: 增加权限", notes = "")
    @PostMapping
    ...
    @ApiOperation(value = "丁兆双: 删除权限", notes = "")
    @DeleteMapping
    ...
    @ApiOperation(value = "丁兆双: 更新权限", notes = "")
    @PatchMapping("/info")
    ...
    @ApiOperation(value = "丁兆双: 列表api权限元数据", notes = "")
    @GetMapping("/meta/api")
