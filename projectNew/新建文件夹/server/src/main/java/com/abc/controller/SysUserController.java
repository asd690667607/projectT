...
/**
 * created by dzsat 2019/3/14 16:41<br>
 */
...
public class SysUserController {
    ...
    @ApiOperation(value = "丁兆双: 添加系统用户", notes = "")
    @PermInfo("添加系统用户")
    ...
    @ApiOperation(value = "丁兆双: 删除系统用户", notes = "")
    @PermInfo("删除系统用户")
    ...
    @ApiOperation(value = "丁兆双: 更新系统用户的角色", notes = "")
    @PermInfo("更新系统用户的角色")
    ...
    @ApiOperation(value = "丁兆双: 查询所有系统用户", notes = "")
    @PermInfo("查询所有系统用户")
    ...
    @ApiOperation(value = "丁兆双: 查询系统用户信息", notes = "")
    @PermInfo("查询系统用户信息")
    ...
    @ApiOperation(value = "丁兆双: 更新系统用户的信息", notes = "")
    @PermInfo("更新系统用户的信息")
    @RequiresPermissions("a:sys:user:info:update")
    @PatchMapping("/info")
    public Json update(@RequestBody String body) {
        System.out.println("更新更新"+body);
    ...
    @ApiOperation(value = "丁兆双: 锁定用户", notes = "")
    @PermInfo("锁定用户")
    @RequiresPermissions("a:sys:user:info:update")
    @PatchMapping("/lock")
    public Json lock(@RequestBody String body) {
    ...
    @ApiOperation(value = "丁兆双: 解除锁定", notes = "")
    @PermInfo("解除锁定")
    @RequiresPermissions("a:sys:user:info:update")
    @PatchMapping("/islock")
    public Json islock(@RequestBody String body) {
        System.out.println("更新更新"+body);
        String oper = "update user";
        log.info("{}, body: {}", oper, body);
    ...
    @ApiOperation(value = "丁兆双: 更新密码", notes = "")
    @PatchMapping("/pwd")
    ...
    @ApiOperation(value = "丁兆双: 查找系统用户的角色", notes = "")
    @PermInfo("查找系统用户的角色")
