    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-card class="box-card">
         ...
         <el-input class="mgb-15" :placeholder="filterPlaceholderText" v-model="filterMenuPermText"></el-input>
        <!--接口权限树  <el-tree ref="menuPermTreeRef" :filter-node-method="filterNode" :data="menuPermissionTree" -->
          <el-tree ref="menuPermTreeRef" :filter-node-method="filterNode" :data="buttonPermissionTree"
            ...
            <span class="custom-tree-node" slot-scope="{ node, data }">
              ...
              <!--  <span class="mgl-10 tips-text">{{ data.pval }}</span> -->
               ...
               <!--接口权限树   <el-tag v-if="!menuPermValSet.has(data.pval)" class="mgl-10" type="danger" size="mini">未同步</el-tag> -->
              </span>
            </span>
          </el-tree>
        </el-card>
          ...
          <el-tree ref="buttonPermTreeRef" :filter-node-method="filterNode" :data="buttonPermissionTree"
            ...
            <span class="custom-tree-node" slot-scope="{ node, data }">
                <span>
                  <span class="mgl-10">{{ data.pname }}</span>
               <!--   <span class="mgl-10 tips-text">{{ data.pval }}</span> -->
                 <!--接口权限树  <el-tag class="mgl-10" v-if="data.ptype==permType.MENU" type="success" size="mini">菜单</el-tag>-->
                 <el-tag class="mgl-10" v-if="data.ptype==permType.MENU" type="success" size="mini">菜单</el-tag>
                  <!--接口权限树 <el-tag class="mgl-10" v-if="data.ptype==permType.MENU" type="warning" size="mini">按钮</el-tag>-->
              ...
              <!--  <span v-if="data.ptype==permType.BUTTON"> -->
                  <span v-if="data.ptype==permType.MENU">
