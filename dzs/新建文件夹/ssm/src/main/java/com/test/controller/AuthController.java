...
import com.test.constant.Codes;
...
public class AuthController {
   ...
   @Autowired private UserService userService;
    ...
    public Json login(@RequestBody String body){
        System.out.println("登录"+"1111111111111");
        ...
        try {
         ...
         // SysUser user = userService.selectUserByUname(uname);
       //  SysUser user = userService.selectUserByUname(uname);
            System.out.println(user+"555555555555555");
